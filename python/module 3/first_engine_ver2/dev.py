...
class MyGame(Game):
    ...
    def run(self):  # рабочая область
        ...
        char.load_sprite(name='attack_right', path='./viking/attack2/right/', update=6)
        char.load_sprite(name='attack_left', path='./viking/attack2/left/', update=6)
